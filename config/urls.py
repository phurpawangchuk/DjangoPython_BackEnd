...
urlpatterns = [
    ...
    path(f"api/v{settings.API_VERSION}/", include("core.v1.posts.urls")),
    path(f"api/v{settings.API_VERSION}/", include("core.v1.reviews.urls")),
    path(f"api/v{settings.API_VERSION}/", include("core.v1.authentication.urls")),
    re_path(
